...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Rafael Vettori', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('rafael.vettori@eventex.com.br', email.body)
        self.assertIn('46-9999999999', email.body)


class SusbscribeInvalidPost(TestCase):
    def setUp(self):
